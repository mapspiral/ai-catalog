...
description: 'Reference for writing clean, safe, and maintainable shell scripts. Use when: generating bash/sh/zsh code, reviewing shell scripts, auditing code quality, establishing team standards, or writing scripts for automation and testing.'
---
